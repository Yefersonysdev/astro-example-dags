...
def load_products():
    ...
    if products_rows>0 :
        ...
        table_id =  "my-project-411522.dep_raw.products"
...
def load_order_items():
    ...
    if order_items_rows>0 :
        client = bigquery.Client(project='my-project-411522')
        table_id =  "my-project-411522.dep_raw.order_items"
        job_config = bigquery.LoadJobConfig(
            schema=[
                bigquery.SchemaField("_id", bigquery.enums.SqlTypeNames.STRING),
                bigquery.SchemaField("order_date", bigquery.enums.SqlTypeNames.DATE),
...
def load_customers():
    ...
    if customers_rows>0 :
        client = bigquery.Client(project='my-project-411522')
        table_id =  "my-project-411522.dep_raw.customers"
        job_config = bigquery.LoadJobConfig(
            schema=[
                bigquery.SchemaField("_id", bigquery.enums.SqlTypeNames.STRING),
...
def load_categories():
    ...
    if categories_rows>0 :
        client = bigquery.Client(project='my-project-411522')
        table_id =  "my-project-411522.dep_raw.categories"
        job_config = bigquery.LoadJobConfig(
            schema=[
...
def load_departments():
    ...
    if departments_rows>0 :
        client = bigquery.Client(project='my-project-411522')
        table_id =  "my-project-411522.dep_raw.departments"
        job_config = bigquery.LoadJobConfig(
            schema=[
